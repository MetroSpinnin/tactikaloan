...
<html lang="en">
  <head>
   <meta charset="utf-8">
    ...
    <style>@font-face{font-family:all; src:url('{{asset('fonts/Nunito-Regular.woff')}}')format('woff');} *{font-family: all;} .bg-darky{background:lavender !important;}.dotter{border:2px dashed green; border-radius:100%;}.bg-gradient {background: linear-gradient(135deg, #283c86 0%, #45a247 100%) !important;}.navabar-toggler{color:green}</style>
  </head>
          ...
          <div class="row align-items-center">
            ...
            <div class="col-md-12">
              <div class="overflow-visible" data-flickity='{ "cellAlign": "center", "contain": true, "prevNextButtons": false, "pageDots":false, "wrapAround":true, "autoPlay":5000, "imagesLoaded":true, "initialIndex":3, "draggable":false }'>
                ...
                <div class="carousel-cell col-11" style="background:lavender; border-radius:5px; padding:15px;">
